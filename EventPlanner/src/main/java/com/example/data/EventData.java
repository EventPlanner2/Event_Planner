...
public class EventData {
    ...
    private  void initializeData() {
        ...
        Event e1 = new Event(CREATOR_NAME, 1, "Ali Turabi's Event", "cars event",
        ...
        Event e2 = new Event(CREATOR_NAME, 2, "Ali Turabi's Event", "mpower bmw version",
        ...
        Event e3 = new Event(CREATOR_NAME, 3, "Ali Turabi's Event", "mpower bmw version",
                LocalDate.of(2025, 6, 20), LocalDate.of(2025, 6, 20),
