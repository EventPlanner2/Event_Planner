...
public class EventData {
    ...
    private static void initializeData() {
        ...
        Event e1 = new Event("Ali Turabi",1, "Ali Turabi's Event", "cars event",
        ...
        Event e2 = new Event("Ali Turabi",2, "Ali Turabi's Event", "mpower bmw version",
        ...
        Event e3 = new Event("Ali Turabi",3, "Ali Turabi's Event", "mpower bmw version",
                LocalDate.of(2025, 6, 20), LocalDate.of(2025, 6, 20),
